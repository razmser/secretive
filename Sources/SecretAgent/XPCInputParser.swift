...
public final class XPCAgentInputParser: SSHAgentInputParserProtocol {
    ...
    private let logger = Logger(subsystem: "com.razmser.secretive.secretagent", category: "XPCAgentInputParser")
    ...
    public init() async throws {
        ...
        session = try await XPCTypedSession(serviceName: "com.razmser.Secretive.SecretAgentInputParser", warmup: true)
