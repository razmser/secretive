...
struct AboutViewContent: View {
    ...
    var body: some View {
        VStack(spacing: 10) {
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        Button(.aboutViewOnGithubButton) {
                            openURL(URL(string: "https://github.com.razmser/secretive")!)
                        }
                            .normalButton()
            ...
            Text(.aboutThanks(contributorsLink: "https://github.com.razmser/secretive/graphs/contributors", sponsorsLink: "https://github.com/sponsors/maxgoedjen"))
                .font(.headline)
