...
@Observable public final class Updater: UpdaterProtocol, Sendable {
    ...
    public func checkForUpdates() async throws {
        let session = try await XPCTypedSession<[Release], Never>(serviceName: "com.razmser.Secretive.SecretiveUpdater")
...
extension Updater {
    ...
    var defaults: UserDefaults {
        UserDefaults(suiteName: "com.razmser.Secretive.updater.ignorelist")!
    }
