...
extension NSNotification.Name {
    ...
    public static let secretStoreUpdated = NSNotification.Name("com.razmser.Secretive.secretStore.updated")
    // Internal notification that keys were reloaded from the backing store.
    public static let secretStoreReloaded = NSNotification.Name("com.razmser.Secretive.secretStore.reloaded")
