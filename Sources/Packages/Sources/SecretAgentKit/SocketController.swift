...
public struct SocketController {
    ...
    private let logger = Logger(subsystem: "com.razmser.secretive.secretagent", category: "SocketController")
...
extension SocketController {
    ...
    public struct Session: Sendable {
        ...
        private let logger = Logger(subsystem: "com.razmser.secretive.secretagent", category: "Session")
